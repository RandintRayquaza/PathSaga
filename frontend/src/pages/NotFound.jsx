...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-ink-950 flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="font-display text-2xl text-ink-100 mb-2 -mt-4">Page not found</h1>
      <p className="text-ink-400 text-sm mb-8 max-w-xs">You've wandered off the path. Let's get you back on track.</p>
